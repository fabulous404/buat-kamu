...
function clik (btn){
  btn.textContent == "Iya " ? img.src = "berdua.jpg" : img.src = "patahHati.gif" 
  button[0].style.display = "none"
  button[1].style.display = "none"
  ctn.style.height = "250px"
  ctn.style.width = "270px"
  return btn.textContent == "Iya " ? kata.textContent = "lucu bett yaa kita ♡" : kata.textContent = "😭😭😭😭😭😭"
...
function content(){
  ...
  kata.textContent = "Hay, sayangg maafinn mas yaa ♡"
}
